...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-isingfit-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13381&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-isingfit-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-isingfit` can be installed with:

```
conda install r-isingfit
```

It is possible to list all of the versions of `r-isingfit` available on your platform with:
